...
The resonant frequencies of the system in Equation \eqref{eq:Mtot} (the same as equation \ref{eq:eqm:und}) can be derived solving an eigenvalue problem stated as follows:
\begin{scatola}{The resonant frequencies , modal shape vectors and eigenvalue problem}
	\label{box:eig_prob}
	 \\
			Given the system expressed in \eqref{eq:Mtot} define a resonant frequency an $\omega > 0$ with $x_e \neq 0_v \in \Re^3 $ such that :
		\begin{equation}
